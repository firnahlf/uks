...
$query = mysqli_query($koneksi, "SELECT * FROM data_kunjungan WHERE id_kunjungan ='$id_kunjungan'");
    ...
    <div class="panel-body">
        <form class="form-horizontal" action="proses_edit_obat.php" method="POST" enctype="multipart/form-data" name="form">
            ...
            <div class="form-group">
                <label for="id_obat" class="col-sm-2 control-label">ID Kunjungan</label>
                <div class="col-sm-10">
